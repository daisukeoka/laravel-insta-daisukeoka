...
<form action="{{ route('admin.users') }}" method="get" class="ms-auto mb-3 w-25">
    <input type="text" name="search" id="search" placeholder="Search..." value="{{ $search }}" class="form-control form-control-sm">
</form>
